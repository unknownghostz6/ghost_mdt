    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('http://ghost_mdt/getWarrants');
        ...
        OffenderSearch() {
            if (this.offender_search) {
                ...
                $.post('http://ghost_mdt/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('http://ghost_mdt/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://ghost_mdt/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://ghost_mdt/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && this.report_new.incident) {
                $.post('http://ghost_mdt/submitNewReport', JSON.stringify({
        ...
        SubmitNote() {
            if (this.note_new.title && this.note_new.note) {
                $.post('http://ghost_mdt/submitNote', JSON.stringify({
        ...
        OpenOffenderDetailsById(charidentifier) {
            $.post('http://ghost_mdt/getOffender', JSON.stringify({
        ...
        DeleteSelectedReport() {
            $.post('http://ghost_mdt/deleteReport', JSON.stringify({
        ...
        DeleteSelectedNote() {
            $.post('http://ghost_mdt/deleteNote', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://ghost_mdt/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        SaveNoteEditChanges() {
            $.post('http://ghost_mdt/saveNoteChanges', JSON.stringify({
                id: this.note_selected.id,
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://ghost_mdt/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://ghost_mdt/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://ghost_mdt/getReport', JSON.stringify({
                id: id
            }));
            this.modal = 'loading';
            return;
